          ...
          <VStack gap={4} align="stretch">
            <Box>
              ...
              <Text color="gray.600" _dark={{ color: "gray.300" }}>
                Codecrafting collecte des données personnelles uniquement lorsque vous nous les fournissez
                volontairement, notamment via nos formulaires de contact. Ces données incluent votre nom,
                adresse email, et tout autre information que vous choisissez de partager.
              </Text>
            </Box>
            ...
            <Box>
              ...
              <Text color="gray.600" _dark={{ color: "gray.300" }}>
                ...
                améliorer nos services, et vous tenir informé de nos actualités si vous y avez consenti.
            ...
            <Box>
              ...
              <Text color="gray.600" _dark={{ color: "gray.300" }}>
                ...
                Les cookies sont de petits fichiers stockés sur votre appareil qui nous aident à
                comprendre comment vous utilisez notre site. Vous pouvez configurer votre navigateur
            ...
            <Box>
              ...
              <Text color="gray.600" _dark={{ color: "gray.300" }}>
                ...
                aux finalités pour lesquelles elles ont été collectées, ou conformément aux obligations légales.
              </Text>
            </Box>
